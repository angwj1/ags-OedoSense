...
# show splash screen (try to display "splash screen" as early as possible before import)
# this actually slows down the program by 3s but gives the user a feedback that the program is loading in the background

# DISPLAY_TIME_MS = 3000
# window = sg.Window("Loading Window", [[sg.T("LOADING...")]], no_titlebar=True).read(timeout=DISPLAY_TIME_MS,close=True)
